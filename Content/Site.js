...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,d3,Site,Samples,WebSharper,List,Circles,Set,FocusBrushing,Client,Number,Arrays,Builder,T,Sample,document,Html,PageletExtensions,Default,jQuery,Operators,EventsPervasives,Seq;
 Runtime.Define(Global,{
  Site:{
   Circles:{
   ...
   Samples:{
    ...
    Sample:Runtime.Class({
     Show:function()
     {
      ...
      return PageletExtensions["IPagelet.AppendTo"](Default.Script(List.ofArray([Default.Attr().NewAttr("src",arg10)])),"main-left");
     }
    },{
