...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Seq,Operators,d3,Math,IntrinsicFunctionProxy,Site,Samples,List,Circles,Set,FocusBrushing,CompaniesGraph,UI,Client,jQuery,Data,Concurrency,Arrays,Html,Default,T,Operators1,Data1,Number,Builder,Sample,document,PageletExtensions,Unchecked,EventsPervasives;
 Runtime.Define(Global,{
  Site:{
   Circles:{
